...
const PropertyType = z.enum(['APARTMENT', 'HOUSE', 'STUDIO', 'COMMERCIAL', 'OTHER']);
...
export const createListingSchema = z.object({
  ...
  floor: z.string().optional().nullable().transform(val => val === null ? undefined : val),
  ...
  equipment: z.string().optional().nullable().transform(val => val === null ? undefined : val),
  ...
  proximity: z.string().optional().nullable().transform(val => val === null ? undefined : val),
  additionalInfo: z.string().optional().nullable().transform(val => val === null ? undefined : val),
});
